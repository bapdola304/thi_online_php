...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2019 at 02:39 PM
...
(8, 'SI39', 'null', 'Điểm nhiệt độ mà ở đó hai mạch của phân tử AND tách ra thì gọi là nhiệt độ nóng chảy của AND. Nhiệt độ nóng chảy cao nhất khi AND có tỉ lệ', 'X = 10%', 'null', 'X = 20%', 'null', 'X = 40%', 'null', 'X = 30%', 'null', 'A', 'null'),
(9, 'SI311', 'null', 'Ở nam giới, khi quá trình giảm phân I bị rối loạn, giảm phân II diễn ra bình thường thì có thể sinh ra các loại giao tử là', '22A, 22A + XX', 'null', '22A + X, 22A +YY', 'null', '22A + XX, 22A +YY', 'null', '22A + XY,22A', 'null', 'C', 'null'),
...
(13, 'SI315', 'hinhSI315.jpg', 'Cho sơ đồ phả hệ một bệnh di truyền ở người. Hình tròn và vuông màu đen tương ứng với những người nữ và nam bị bệnh, những hình màu trắng thể hiện người không bị bệnh. Quy luật di truyền của bệnh là', 'Di truyền gen lặn trên NST X và gen trong tế bào chất.', 'null', 'Di truyền gen trên NST Y và gen trội trên NST thường.', 'null', 'Di truyền gen tế bào chất và gen lặn trên NST thường.', 'null', 'Di truyền gen lặn trên NST thương và trên NST giới tính ở vùng tương đồng.', 'null', 'D', 'null'),
...
(18, 'SI320', 'null', 'Nếu trong một quần thể đang ở trạng thái cân bằng Hacđi- Vanbec  có số cá thể mang kiểu gen aa chiếm tỉ lệ 4%, thì tỉ lệ phần trăm của các cá thể có kiểu gen AA bằng bao nhiêu?', '64%', 'null', '81%', 'null', '36%', 'null', '96%', 'null', 'D', 'null'),
...
(22, 'SI324', 'null', 'Trong tạo giống bằng công nghệ tế bào, người ta có thể tạo ra giống cây trồng mới mang đặc điểm của hai loài khác nhau nhờ phương pháp', 'Dung hợp tế bào trần', 'null', 'Nuôi cấy tế bào thực vật invitro tạo mô sẹo', 'null', 'Chọn dòng tế bào xôma có biến dị ', 'null', 'Nuôi cấy hạt phấn', 'null', 'C', 'null'),
(23, 'SI325', 'null', 'Khi nói về bệnh phên in kê tô niệu ở người, phát biểu nào sau đây là đúng?', 'Bệnh phêninkêtô niệu là do lượng axit amin tirôzin dư thừa và ứ đọng trong máu, chuyển lên não gây ra đầu độc tế bào thần kinh.', 'null', 'Có thể phát hiện ra bệnh phêninkêtô niệu bằng cách làm tiêu bản tế bào và quan sát hình dạng NST dưới kính hiển vi.', 'null', 'Chỉ cần loại bỏ hoàn toàn axit amin phêninlanin ra khỏi phần ăn của người bệnh sẽ trở nên khỏe mạnh hoàn toàn.', 'null', 'Bệnh phêninkêtô niệu là bệnh do đột biến gen mã hóa enzim xúc tác phản ứng chuyển hóa axit amin phêninalanin thành tirôzin trong cơ thể', 'null', 'B', 'null'),
(24, 'SI326', 'null', 'Ở người, alen A : quy định nhinf màu bình thường, trội hoàn toàn so với alen a : bệnh mù màu, gen này nằm trên NST X. Hai anh em đồng sinh cùng trứng, người anh (1) bình thường có vợ (2) bị bệnh sinh con đầu lòng (3) không bị bệnh này. Người em (4) có vợ (5) không bị bệnh sinh con đầu lòng (6) bị bệnh này. Kiểu gen của những người từ (1) đến (6) lần lượt là', 'XᴬY,XᵃXᵃ,XᴬXᵃ,XᴬY,XᴬXᴬ,XᵃY.', 'null', 'XᴬY,XᵃXᵃ,XᴬXᵃ,XᴬY,XᴬXᵃ,XᵃY.', 'null', 'XᴬY,XᵃXᵃ,XᴬY,XᴬY,XᴬXᵃ,XᵃY.', 'null', 'XᴬY,XᵃXᵃ,XᴬXᵃ,XᴬY,XᴬXᵃ,XᵃXᵃ.', 'null', 'A', 'null'),
(25, 'SI327', 'null', 'Từ cây cải hoang dại qua chọn giống hình thành nên cải bắp, súp lơ xanh, cải Bruxen, cải xoăn, su hào. Đây là ví dụ về', 'CLTN', 'null', 'chọn lọc nhân tạo', 'null', 'Tiến hóa hội tụ', 'null', 'đấu tranh sinh tồn', 'null', 'D', 'null'),
...
(30, 'SI332', 'null', 'Các nhân tố vừa làm thay đổi tần số alen, vừa làm thay đổi thành phần kiểu gen của quần thể là (1) CLTN (2) Giao phối ngẫu nhiên (3) Giao phối không ngẫu nhiên (4) Các yếu tố ngẫu nhiên (5) Đột biến (6) Dị - nhập gen', '(1),(3),(4),(5).', 'null', '(1),(4),(5),(6).', 'null', '(3),(4),(5),(6).', 'null', '(1),(3),(5),(6).', 'null', 'D', 'null'),
...
(34, 'SI336', 'null', 'Ở F2 thu được tỉ lệ phân li kiểu hình là 9/16 hoa có màu : 7/16 hoa màu trắng. Nếu lấy ngẫu nhiên một cây hoa có màu đem tự thụ phấn thì xác suất thu được thế hệ con không có sự phân li về kiểu hình là bao nhiêu?', '1 /9.', 'null', '1 /3.', 'null', '9 /7.', 'null', '9 /16.', 'null', 'D', 'null'),
...
(38, 'SI340', 'null', 'Cho chuỗi thức ăn: Cây ngô → Sâu ăn lá → Nhái → Rắn hổ mang  → Diều hâu. Trong chuỗi thức ăn này, bậc dinh dưỡng cấp 3 và sinh vật tiêu thụ bậc 1 lần lượt là ', 'nhái,sâu', 'null', 'rắn hổ mang, cây ngô', 'null', 'nhái, cây ngô', 'null', 'sâu, nhái', 'null', 'C', 'null'),
(39, 'SI41', 'null', 'Sự tổng hợp ARN chủ yếu diễn ra ở kì nào của quá trình phân bào?', 'Kì giữa của quá trình nguyên phân hoặc giảm phân.', 'null', 'Kì đầu của quá trình nguyên phân hoặc giảm phân.', 'null', 'Kì trung gian trước khi tiến hành phân bào nguyên phân hoặc giảm phân.', 'null', 'Kì sau của quá trình nguyên phân hoặc kì sau I của quá trình giảm phân.', 'null', 'B', 'null'),
...
(42, 'SI44', 'null', 'Yếu tố chủ yếu quy định tính đặc trưng về cấu trúc hóa học của phân tử AND là', 'Số lượng nuc lêôtit.', 'null', 'số loại nuclêôtit.', 'null', 'trình tự phân bố nuclêôtit', 'null', 'thành phần và số lượng của nuclê tit.', 'null', 'D', 'null'),
(43, 'SI45', 'null', 'Kì nào sau đây trong phân bào giảm phân, NST tồn tại ở dạng từng cặp NST tương đồng kép?', 'Kì giữa I của giảm phân.', 'null', 'Kì cuối I của giảm phân.', 'null', 'Kì giữa II của giảm phân.', 'null', 'Kì sau II của giảm phân.', 'null', 'C', 'null'),
(44, 'SI46', 'null', 'Quá trình tiếp hợp và trao đổi NST xảy ra ở kì nào của quá trình giảm phân?', 'Kì trung gian.', 'null', 'Kì đầu I.', 'null', 'Kì giữa II.', 'null', 'Kì sau II.', 'null', 'C', 'null'),
(45, 'SI47', 'null', 'Ở sinh vật sinh sản hữu tính, bộ NST được ổn định qua các thế hệ là nhờ', 'Cơ chế nhân đôi NST', 'null', 'Cơ chế phân li NST', 'null', 'Sự phân li, tỏ hợp NST', 'null', 'Quá trình nguyên phân, giảm phân và thụ tinh', 'null', 'A', 'null'),
...
(47, 'SI49', 'null', 'Biết rằng mỗi gen quy định một tính trạng, trội- lặn hoàn toàn, phép lai nào sau đây cho đời con chỉ biểu hiện tính trạng trội?', 'AaBb Î Aabb', 'null', 'AaBB Î AABb', 'null', 'AaBb Î AaBb', 'null', 'AaBb Î aabb', 'null', 'D', 'null'),
...
(52, 'SI414', 'null', 'Phé lai thường được sử dụng để phát hiện ra hiện tượng các gen di truyền liên kết hay hoán vị là', 'Lai bố mẹ thuần chủng với nhau.', 'null', 'Lai thuận nghịch kết hợp với lai phân tích.', 'null', 'Lai bão hòa.', 'null', 'Lai ngược con cái với bố mẹ.', 'null', 'D', 'null'),
(53, 'SI415', 'null', 'Ý nghĩa của hiện tượng các gen liên kết hoàn toàn trong chọn giống vật nuôi, cây trồng là', 'Cho phép lập bản đồ di truyền.', 'null', 'Hạn chế các gen bất lợi xuất hiện.', 'null', 'Nhận thấy các tính trạng có lợi của giống.', 'null', 'Đảm bảo sự di truyền ổn định của từng nhóm gen quý.', 'null', 'C', 'null'),
(54, 'SI416', 'null', 'Ở cà chua, alen A quy định thân cao trội hoàn toàn so với alen a thân thấp. Alen B quy định quả tròn trội hoàn toàn so với alen b quả dài. Cho giao phấn 2 cây thuần chuẩn (P) khác nhau về 2 cặp tính trạng, thu được F1 100% thân cao, quả tròn. Cho F1 tự thụ phấn thu được F2 : 0,5016 thân cao, quả tròn ; 0,2484 thân cao, quả dài ; 0,2484 thân thấp, quả tròn ; 0,16 thân thấp, quả dài. Cho rằng trong quá trình giảm phân hình thành giao tử cái và giao tử đực đều xảy ra hoán vị gen với tần số ngang nhau. Kiếu gen và tần số hoán vị gen của cây cà chua F1 phải là', 'Ab/aB   ; 16%', 'null', 'Ab/aB   ; 8%', 'null', 'AB/ab   ; 20%', 'null', 'AB / ab  ; 8%', 'null', 'B', 'null'),
(55, 'SI417', 'null', 'Cho biết mỗi gen quy định một tính trạng, trội - lặn hoàn toàn, các gen liên kết hoàn toàn. Theo lý thuyết, phép lai nào sau đây cho đời con có kiểu hình phân li 3 : 1 ?', 'Af/aF Î Af/af', 'null', 'AF/af Î AF/af', 'null', 'AF/af Î af/af', 'null', 'Af/aF Î Af/aF', 'null', 'D', 'null'),
...
(57, 'SI419', 'null', 'Phát biểu nào sau đây là không đúng khi nói về quần thể tự phối?', 'Quần thể bị phân chia thành các dòng thuần.', 'null', 'Sự chọn lọc không mang lại hiệu quả đối với con cháu ở các thể đồng hợp tử.', 'null', 'Qua các thế hệ, số cá thể đồng hợp tử tăng, dị hợp tử giảm dần.', 'null', 'Thế hệ con cháu đa hình về mặt di truyền.', 'null', 'B', 'null'),
(58, 'SI420', 'null', 'Quần thể ban đầu có tần số kiểu gen dị hợp về một gen là 0,4 . Sau hai thế hệ tự thụ phấn thì tần số kiểu gen dị hợp tử trong quần thể sẽ là', '0,3', 'null', '0,1', 'null', '0,2', 'null', '0,4', 'null', 'A', 'null'),
(59, 'SI421', 'null', 'Ở bò, kiểu gen AA có màu lông hung đỏ, kiểu gen Aa lông khoang, kiểu gen aa lông trắng. Một đàn bò có 5 000 con lông hung đỏ, 4 000 con lông khoang, 800 con lông trắng. Tần số tương đối của alen A và a trong quần thể lần lượt là ', '0,71 ; 0,29', 'null', '0,29 ; 0,71', 'null', '0,70 ; 0,30', 'null', '0,30 ; 0,70', 'null', 'D', 'null'),
...
(64, 'SI426', 'null', 'Những cơ quan nào sau đây là cơ quan tương đồng? ', 'Cánh đại bàng và chân trước của bò', 'null', 'Chân đà điểu và cánh dơi', 'null', 'Chân chim cánh cụt và cánh gà', 'null', 'Ngà voi và sừng hươu', 'null', 'B', 'null'),
(65, 'SI427', 'null', 'Những cơ quan nào sau đây là cơ quan tương tự? ', 'Lá thông và gai xương rồng.', 'null', 'cánh chim bồ câu và cánh chuồn chuồn', 'null', 'xương đòn của chó nhà và xương mỏ ác của gà', 'null', 'tua cuốn bí ngô và gai hoa hồng', 'null', 'A', 'null');
