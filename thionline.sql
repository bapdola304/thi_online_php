...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2019 at 12:28 PM
...
(41, 'LY41', 'null', 'Pha ban đầu của dao động điều hòa phụ thuộc vào', 'Tần số và năng lượng dao động.', 0, 'Gốc thời gian và trục tọa độ.', 'null', 'Gốc thời gian và chu kì dao động.', 'null', 'Biên độ và chu kì dao động.', 'null', 'null', 'null'),
(42, 'LY42', 'null', 'Biên độ dao động cưỡng bức không thay đổi khi thay đổi ', 'Lực ma sát của môi trường.', 0, 'Pha ban đầu của lực cưỡng bức.', 'null', 'Biên độ của lực cưỡng bức.', 'null', 'Tần số của lực cưỡng bức.', 'null', 'null', 'null'),
(43, 'LY43', 'null', 'Li độ x = Acos(ωt + ϕ) của một dao động điều hòa bằng 0,5 A khi pha dao động bằng', '0', 0, '±π/6.', 'null', '±π/3.', 'null', '±π/2.', 'null', 'null', 'null'),
(44, 'LY44', 'null', 'Tốc độ truyền âm trong môi trường nào sau đây là lớn nhất.', 'Không khí loãng.', 0, 'Không khí.', 'null', 'Nước nguyên chất.', 'null', 'Chất rắn.', 'null', 'null', 'null'),
(45, 'LY45', 'null', 'Khi có sóng dừng trên một sợi dây đàn hồi, khoảng cách từ một bụng đến nút gần nó nhất bằng', 'Một bước sóng.', 0, 'Nửa bước sóng.', 'null', 'Một phần tư bước sóng.', 'null', 'Một số nguyên lần nửa bước sóng.', 'null', 'null', 'null'),
(46, 'LY46', 'null', 'Cho A, B là hai nguồn sóng cơ kết hợp, dao động ngược pha nhau. Một điểm cách hai nguồn các khoảng d₁ và d₂ dao động với biên độ cực đại nếu điều kiện nào nêu dưới đây thỏa mãn ( với k nguyên)?', 'null', 0, 'null', 'hinhly6b.jpg', 'null', 'hinhly6c.jpg', 'null', 'hinhly6d.jpg', 'null', 'null'),
(47, 'LY47', 'null', 'Cho đoạn mạch xoay chiều có R, L, C mắc nối tiếp. Gọi U là điện áp hiệu dụng giữa hai đầu đoạn mạch; U(R),U(L) và U(C) là đoạn áp hiệu dụng giữa hai đầu R, L và C. Điều nào sau đây không thể xảy ra?', 'U(R) > U.', 0, 'U(L )> U.', 'null', 'U(R) > U(C).', 'null', 'U = U(R) = U(L) = U(C).', 'null', 'null', 'null'),
...
(49, 'LY49', 'null', 'Một đoạn mạch gồm một tụ điện mắc nối tiếp với điện trở thuần. Nếu đặt điện áp u = U√2cosωt vào hai đầu đoạn mạch thì điện áp hiệu dụng giữa hai đầu tụ điện là U/2. Khi đó hệ số công suất của mạch là', '1/√2', 0, '1', 'null', '√2/3', 'null', '√3/2', 'null', 'null', 'null'),
(50, 'LY410', 'null', 'Để tìm sóng có bước sóng λ trong máy thu vô tuyến điện, người ta phải điều chỉnh giá trị của điện dung C và độ tự cảm L trong mạch dao động của máy. Giữa λ, L và C phải thỏa mãn hệ thức nào sau đây?', '2π√ = c/λ.', 0, '2π√LC  = λc.', 'null', '2π√LC = λ/c.', 'null', '√LC/2π =λ/c.', 'null', 'null', 'null'),
...
(52, 'LY412', 'null', 'Trong mạch dao động LC lí tưởng đang có dao động điện từ tự do, điện tích trên một bản của tụ điện và cường độ dòng điện qua cuộn cảm biến thiên điều hòa theo thời gian', 'Với cùng tần số.', 0, 'Luôn ngược pha nhau.', 'null', 'Luôn cùng pha nhau.', 'null', 'Cùng với biên độ.', 'null', 'null', 'null'),
(53, 'LY413', 'null', 'Tìm phát biểu sai. Trong sơ đồ khối của một máy thu vô tuyến, bộ phận có trong máy phát sóng vô tuyến là', 'anten.', 0, 'Mạch biến điệu.', 'null', 'Mạch tách sóng.', 'null', 'Mạch tách sóng.', 'null', 'null', 'null'),
(54, 'LY414', 'null', 'Máy quang phổ lăng kính hoạt động dựa trên nguyên tắc của hiện tượng quang học nào sau đây?', 'Phản xạ ánh sáng.', 0, 'Giao thoa ánh sáng.', 'null', 'Tán sắc ánh sáng.', 'null', 'Quang điện.', 'null', 'null', 'null'),
(55, 'LY415', 'null', 'Trong thí nghiệm Y-âng về giao thoa với ánh sáng đơn sắc, khoảng cách từ vân tối thứ 2 đến  vâng sáng bậc 5 bằng bao nhiêu lần khoảng vân i?', '3i.', 0, '3,5i.', 'null', '4i.', 'null', '4,5i.', 'null', 'null', 'null'),
(56, 'LY416', 'null', 'Nếu gọi ε₁,ε₂,ε₃  lần lượt là năng lượng của phôtôn ứng với các bức xạ đơn sắc lam, chàm, tím, thì ta có:', 'ε₁<ε₂<ε₃.', 0, 'ε₁>ε₂>ε₃.', 'null', 'ε₁<ε₃<ε₂.', 'null', 'ε₂<ε₁<ε₃.', 'null', 'null', 'null'),
(57, 'LY417', 'null', 'Một chất phát quang có khả năng phát ra ánh sáng màu vàng lục khi được kích thích phát sáng. Khi chiếu vào chất đó ánh sáng đơn sắc nào dưới đây thì chất đó có thể phát quang?', 'Lục.', 0, 'Vàng.', 'null', 'Da cam.', 'null', 'Đỏ.', 'null', 'null', 'null'),
(58, 'LY418', 'null', 'Một ống Rơn-ghen phát ra tia X có bước sóng nhỏ nhất là λ(min) = 5.10¯¹º m. Năng lượng phôtôn tương ứng và hiệu điện thế giữa anôt và canôt của ống vào khoảng:', 'ε= 4.10¯¹³ J; U = 25 V.', 0, 'ε= 4.10¯¹³ J; U = 2500 V.', 'null', 'ε= 4.10¯¹⁶ J; U = 2500 V.', 'null', 'ε= 4.10¯¹⁸ J; U = 250 V.', 'null', 'null', 'null'),
(59, 'LY419', 'null', 'Một hạt nhân có năng lượng liên kết càng lớn thì ', 'Có độ hụt khối càng lớn.', 0, 'Năng lượng liên kết riêng càng lớn.', 'null', 'Năng lượng liên kết riêng càng nhỏ.', 'null', 'Có độ hụt khối càng nhỏ.', 'null', 'null', 'null'),
(60, 'LY420', 'null', 'So với hạt nhân ¹²₆C , hạt nhân ²º₁₀Ne có nhiều hơn', '8 nơtron và 4 prôtôn.', 0, '4 nơtron và 4 prôtôn.', 'null', '4 nơtron và 8 prôtôn.', 'null', '8 nơtron và 8 prôtôn.', 'null', 'null', 'null'),
(61, 'LY421', 'null', 'Chất phóng xạ X có chu kì bán rã T. Sau bao lâu thì tỉ lệ phần trăm số hạt nhân X bị phân rã là 87,5%?', 'T/2.', 0, 'T/4.', 'null', '2T.', 'null', '3T.', 'null', 'null', 'null'),
(62, 'LY422', 'null', 'Tìm phát biểu sai.Phản ứng dây chuyền', 'Là phản ứng phân hạch liên tiếp xảy ra.', 0, 'Luôn kiểm soát được.', 'null', 'Được ứng dụng vào các nhà máy điện hạt nhân .', 'null', 'Xảy ra khi số nơtron trung bình nhận được sau mỗi phân hạch bằng 1.', 'null', 'null', 'null'),
(63, 'LY423', 'null', 'Một con lắc lò xo gồm quả nặng khối lượng m, gắn với lò xo nhẹ có độ cứng k, dao động điều hòa theo phương nằm ngang với biên độ A và tần số góc ω . Tại thời điểm mà thế năng đàn hồi của lò xo bằng động năng của quả nặng thì gia tốc của quả nặng có độ lớn là', 'Aω²/2.', 0, '√2  Aω²/3', 'null', 'Aω²/√2', 'null', '2Aω²/√3', 'null', 'null', 'null'),
(64, 'LY424', 'null', 'Thí nghiệm nào sau đây có thể dùng để đo bước sóng ánh sáng?', 'Thí nghiệm tán sắc ánh sáng của Niu-tơn.', 0, 'Thí nghiệm tổng hợp ánh sáng trắng.', 'null', 'Thí nghiệm giao thoa ánh sáng với khe Y-âng.', 'null', 'Thí nghiệm khúc xạ của ánh sáng đơn sắc.', 'null', 'null', 'null'),
(65, 'LY425', 'null', 'Hai khe Y-âng cách nhau 3 mm được chiếu bằng ánh sáng đơn sắc có bước sóng 0,60 µm . Các vân giao thoa được hứng trên màn cách hai khe 2 m. Tại điểm M cách vân trung tâm 1,2 mm có', 'Vân sáng bậc 2.', 0, 'Vân sáng bậc 3.', 'null', 'Vân tối thứ 2.', 'null', 'Vân tối thứ 3.', 'null', 'null', 'null'),
(66, 'LY426', 'null', 'Một con lắc lò xo treo thẳng đứng dao động điều hòa với chu kì 0,4 s. Khi vật ở vị trí cân bằng, lò xo dài 44 cm.              Lấy g = r² = 10 m/s².  Chiều dài tự nhiên của lò xo là', '36 cm.', 0, '38 cm.', 'null', '42 cm.', 'null', '40 cm.', 'null', 'null', 'null'),
(67, 'LY427', 'null', 'Biết dao động của một vật là tổng hợp của hai dao động điều hòa cùng phương có phương trình lần lượt là x₁ = 8sin(πt + α) (cm) và x₂ = 4cosπt (cm). Biên độ dao động của vật bằng 12cm nếu', 'α = 0 (rad).', 0, 'α = π/2 (rad)', 'null', 'α= π(rad)', 'null', 'α= -π/2 (rad).', 'null', 'null', 'null'),
(68, 'LY428', 'null', 'Một chất điểm dao động điều hòa dọc theo trục Ox với tần số f và biên độ A. Lúc t = 0 , chất điểm đi từ vị trí cân bằng O, sau khi đi được đoạn đường s thì động năng của chất điểm có trị số là 9,6 J. Khi đi thêm đoạn 2s nữa, động năng còn lại 6,4 J. Nếu đi tiếp thêm đoạn đường 3s nữa thì động năng của chất điểm là', '3,6 J.', 0, '6,4 J.', 'null', '4,8 J.', 'null', '2,4 J.', 'null', 'null', 'null'),
(69, 'LY429', 'null', 'Sóng âm có tần số f truyền từ không khí vào một thanh thép thì bước sóng tăng thêm 19,44 m. Cho tốc độ truyền âm trong không khí và trong thép lần lượt là 340 m/s và và 5200 m/s. Tần số của sóng âm là', '250 Hz.', 0, '230 Hz.', 'null', '350 Hz.', 'null', '50 Hz.', 'null', 'null', 'null'),
(70, 'LY430', 'null', 'Một sóng dọc truyền theo trục Ox có tần số 15 Hz, biên độ 4 cm. Tốc độ truyền sóng là 12 m/s. Xét hai phần tử B và C trên Ox có vị trí cân bằng cách nhau 40 cm. Khoảng cách ngắn nhất giữa hai phần tử B và C khi có sóng truyền qua là', '32 cm.', 0, '48 cm.', 'null', '40 cm.', 'null', '36 cm.', 'null', 'null', 'null'),
(71, 'LY431', 'hinhly431.jpg', 'Cho đoạn mạch có R, L, C mắc nối tiếp, biết điện trở thuần R = 25 Ω. Đặt vào giữa hai đầu đoạn mạch một điện áp xoay chiều ổn định, thì thấy : …. Cường độ dòng điện hiệu dụng qua đoạn mạch là', '3A', 0, '3√2 A', 'null', '3√2/2 A', 'null', '3,3 A', 'null', 'null', 'null'),
(72, 'LY432', 'null', 'Một máy tăng áp có tổng số vòng dây ở hai cuộn thứ cấp và sơ cấp là 2000 vòng. Biết hệ số của máy biến áp là 4, số vòng dây của cuộn sơ cấp là', '400 vòng.', 0, '1600 vòng.', 'null', '500 vòng.', 'null', '1500 vòng.', 'null', 'null', 'null'),
(73, 'LY433', 'null', 'Trong mạch có R₁, L₁, C₁ mắc nối tiếp  xảy ra hiện tượng cộng hưởng điện với tần số góc ω₀. Trong mạch có R₂, L₂, C₂ mắc nối tiếp xảy ra hiện tượng cộng hưởng điện với tần số góc 2ω₀. Hệ số tự cảm L₁ = 2L₂. Nếu mắc nối tiếp hai đoạn mạch này với nhau thì trong mạch xảy ra cộng hưởng điện với tàn số goc là', 'ω₀√2.', 0, 'ω₀√3.', 'null', 'ω₀/√2.', 'null', 'ω₀     √3/2.', 'null', 'null', 'null'),
...
(75, 'LY435', 'null', 'Đặt điện áp u = U√2 cosωt (V) vào hai đầu đoạn mạch điện gồm cuộn cảm thuần mắc nối tiếp với một biến trở. Ứng với hai giá trị  của biến trở là R₁ = 10 Ω và R₂ = 40 Ω thì công suất tiêu thụ trong đoạn mạch đều bằng 200 W. Giá trị của U là', '100 V.', 0, '200 V.', 'null', '50√2 V.', 'null', '50 V.', 'null', 'null', 'null'),
(76, 'LY436', 'null', 'Trong thí nghiệm giao thoa ánh sáng với khe Y-âng, khoảng cách giữa hai khe là a = 2 mm, khoảng cách giữa hai khe và màn là D = 1 m. Khi dùng bức xạ có bước sóng λ₁ thì khoảng vân là i₁ = 0,2 mm. Khi dùng bức xạ λ₂ > λ₁ thì tại vị trí vân sáng bậc ba của bức xạ λ₁, ta quan sát được một vân sáng bậc k của λ₂. Bước sóng λ₂ bằng', '0,50 µm.', 0, '0,70 µm.', 'null', '0,60 µm.', 'null', '0,65 µm.', 'null', 'null', 'null'),
(77, 'LY437', 'null', 'Theo mẫu nguyên tử Bo, khi nguyên tử hiđrô chuyển từ trạng thái dừng có năng lượng E₃ = -1,5 eV sang trạng thái dừng có năng lượng E₂ = -3,4 eV thì phát ra một phôtôn ứng với bức xạ có bước sóng là', '0,654.10¯⁷ m.', 0, '0,654.10¯⁶ m.', 'null', '0,654.10¯⁵ m.', 'null', '0,654.10¯⁴', 'null', 'null', 'null'),
(78, 'LY438', 'null', 'Dùng hạt prôtôn có động năng W(đp) = 5,68 MeV bắn vào hạt nhân ²³₁₁Na đứng yên, ta thu được hạt α và hạt X có động năng tương ứng là 6,15 MeV và 1,91 MeV. Coi rằng phản ứng không kèm theo bức xạ gamma, lấy khối lượng hạt nhân tính theo u gần bằng số khối của nó. Goc giữa vectơ vận tốc của hạt X xấp xỉ bằng ', '159°.', 0, '137°.', 'null', '98°.', 'null', '70°.', 'null', 'null', 'null'),
(79, 'LY439', 'null', 'Trong các nguồn bức xạ đang hoạt động sau đây, nguồn nào phát ra bức xạ từ ngoại mạnh nhất', 'Hồ quang điện.', 0, 'lò sưởi điện.', 'null', 'Lò vi sóng.', 'null', 'Màn hình vô tuyến.', 'null', 'null', 'null'),
